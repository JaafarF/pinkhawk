            ...
            <div className="tweet-header">
              ...
              <div className="tweet-header-info">
                ...
                <p className="tweet-text">
                  Everything turns so easy with @PinkHawk!
                  <br /> Highly recommended if you want to post on twitter with
                  automation tool and to manage your followers easily!
                </p>
                ...
                <div className="tweet-info-counts">
                  ...
                  <div className="likes">
                    <img
                      ...
                      alt="likeHeart"
                    />
                    <div className="likes-count">2.3k</div>
                  </div>
                </div>
              </div>
            </div>
